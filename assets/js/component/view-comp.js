...
export const View = {
  ...
  <div class="sub-container view" id="main">
                ...
                <div class="product-slide">
                  <div class="product-slide-wrap">
                    <div class="product-detail-img">
                      <img src="/FED-TEAM-6401/assets/img/view/item1/img_item_01.jpg" alt="이브닝글로우" />
                    </div>
                    <div class="product-detail-img">
                      <img src="/FED-TEAM-6401/assets/img/view/item1/img_item_02.jpg" alt="이브닝글로우" />
                    </div>
                    <div class="product-detail-img">
                      <img src="/FED-TEAM-6401/assets/img/view/item1/img_item_03.jpg" alt="이브닝글로우" />
                    </div>
                    <div class="product-detail-img">
                      <img src="/FED-TEAM-6401/assets/img/view/item1/img_item_04.jpg" alt="이브닝글로우" />
                    </div>
                  </div>
                          ...
                          <li>
                            ...
                            <div class="accordion-cont">
                              ...
                              <div class="shopping-box-wrap">
                                <h2>유료 쇼핑백 서비스</h2>
                                <img src="/FED-TEAM-6401/assets/img/view/shoppingBag_v1.jpg" alt="쇼핑백">
    ...
    mounted(){
      $('head').append(`
        <link rel="stylesheet" type="text/css" href="/FED-TEAM-6401/assets/css/product-view.css" />
       `);
      $('head').append(`
        <script type="module" src="/FED-TEAM-6401/assets/js/product_view.js"></script>
       `);
    },
    computed: {
      currentCategory() {
