  ...
  template: `
    <header class="header">
      ...
      <div class="inner-header">
        ...
        <h1 class="logo">
          <a href="/"><img src="/FED-TEAM-6401/assets/img/main/logo_red.svg" alt="TAMBURINS"></a>
        </h1>
        <gnb-comp></gnb-comp>
        <div class="util">
            ...
            <div class="footer-inner">
                <div class="footer-top">
                    <div class="footer-logo">
                        <img src="/FED-TEAM-6401/assets/img/main/logo.svg" alt="TAMBURINS">
                    </div>
                </div>
                <div class="footer-btm">
                    <div class="left">
                      ...
                      <ul class="footer-link">
                        <li><a href="/FED-TEAM-6401/assets/error.html">공지사항</a></li>
